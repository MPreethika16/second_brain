        ...
        <div className="bg-white/60 backdrop-blur-xl border border-white/40 shadow-xl rounded-3xl p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white/60 text-zinc-500 backdrop-blur-xl">Or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            type="button"
            className="w-full bg-white hover:bg-zinc-50 border border-zinc-200 text-zinc-900 font-semibold rounded-xl px-4 py-3.5 shadow-sm flex items-center justify-center gap-3 transition-all hover:-translate-y-0.5"
          >
